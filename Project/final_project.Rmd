...
```{r , echo=FALSE, message=FALSE}
  ...
  title = "Top 10 Debt-to-GDP Ratio", fill = "Development") +
  theme_classic() +
...
dataset_total %>%
  ...
  title = "Top 10 Countries with Debt Held by Foreign Investors", fill = "Development") +
  theme_classic() +
  theme(legend.title = element_text(face = "bold", size = 10)) +
  scale_fill_manual("Development", values = c("EM" = "red4", "AM" = "navyblue"))
...
At the beginning of the period, government debt in emerging markets showed a sharp drop. However, after 2009, the average public debt increased from 38 percentage points of GDP to 48 percent of GDP at the end of 2019.

In contrast, in advanced economies, debt to GDP grew rapidly after 2008, reaching the highest level in 2014 at 84 percent of GDP compared to 53 percent of GDP in 2008.
